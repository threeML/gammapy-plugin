...
#        self.model = likelihood_model
        ...
        model = SkyModel(spectral_model=self.spectral_model, name="{}".format(obs_table['OBJECT'][0]))
...
#        self._dataset_stacked = self._get_gammapy_instance(likelihood_model_instance)
    ...
    def get_log_like(self):
        ...
        self.dataset_stacked = self._get_gammapy_instance(self._likelihood_model)
